...
//             <br />
//             Last updated: {new Date(yourLocation.updatedAt).toLocaleTimeString()}
//           </p>
//         ) : (
//           <p>Fetching...</p>
//         )}
...
//       <div>
//         <h2 className="text-lg font-semibold">Partner's Location</h2>
//         {partnerLocation ? (
//           <p>
//             Lat: {partnerLocation.latitude}, Lng: {partnerLocation.longitude}
//             <br />
//             Last updated: {new Date(partnerLocation.updatedAt).toLocaleTimeString()}
//           </p>
//         ) : (
//           <p>Fetching...</p>
//         )}
...
//       <Button onClick={fetchPartnerLocation}>Refresh Partner Location</Button>
//     </div>
//   )
// }
